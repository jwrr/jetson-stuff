...
__global__ void rowOffsetKernel(DATA_TYPE* imat, DATA_TYPE* omat, int NN, int N_COLS)
{
...
// Define the kernel that will run on the GPU
void rowOffsetKernel_CPU(DATA_TYPE* imat, DATA_TYPE* omat, int NN, int N_COLS)
{
